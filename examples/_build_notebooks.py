...
def step_zero_cells() -> list[dict]:
    ...
    return [
        md(
            ...
            "2. **Environment check** — verifies Python >= 3.10 and all required dependencies, so you get a clear error up front instead of a confusing failure mid-notebook.",
        ...
        code(
            ...
            "    raise RuntimeError(",
            "        f'ffiec-data-connect requires Python >= 3.10, got {sys.version.split()[0]}'",
            "    )",
            "",
