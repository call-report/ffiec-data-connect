...
class AsyncCompatibleClient:
    ...
    def collect_data(
        ...
        return methods.collect_data(
            conn, self.credentials, reporting_period, 
            rssd_id, series, output_type, date_output_format
        )
    ...
    def collect_time_series(
        ...
        """
        with ThreadPoolExecutor(max_workers=min(len(reporting_periods), self.max_concurrent)) as executor:
            futures = {}
            ...
            async with semaphore:
                try:
                    ...
                    result = await self.collect_data_async(
                        ...
                        output_type, date_output_format
                    )
