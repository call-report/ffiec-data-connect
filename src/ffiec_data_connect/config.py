...
class Config:
    ...
    _use_legacy_errors = os.environ.get('FFIEC_USE_LEGACY_ERRORS', 'true').lower() in ('true', '1', 'yes')
    ...
    def reset(cls) -> None:
        ...
        cls._use_legacy_errors = os.environ.get('FFIEC_USE_LEGACY_ERRORS', 'true').lower() in ('true', '1', 'yes')
