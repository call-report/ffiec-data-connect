    ...
    def do_POST(self):
        ...
        try:
            ...
            if soap_action == "TestUserAccess":
                ...
                response = self._generate_retrieve_reporting_periods_response(
                    parameters
                )
                ...
                response = self._generate_filers_submission_datetime_response(
                    parameters
                )
        ...
        try:
            ...
            for elem in root.iter():
                ...
                if tag_name in param_mappings and elem.text:
                    ...
                    elem.text and not elem.text.isspace() and len(elem.text.strip()) > 0
                ):
...
<soap:Envelope xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/"
    ...
    def _generate_retrieve_reporting_periods_response(
...
<soap:Envelope xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/"
    ...
    def _generate_filers_submission_datetime_response(
        self, params: Dict[str, str]
    ) -> str:
    ...
    def _send_wsdl_response(self) -> None:
        ...
        try:
            ...
            wsdl_path = (
                ...
                / "fixtures"
                / "wsdl_samples"
                / "ffiec_real_retrieval_service.wsdl"
            )
            if wsdl_path.exists():
...
class MockFFIECServer:
    ...
    def configure_error_response(
        self, action: str, rssd_id: str, error_message: str
    ) -> None:
