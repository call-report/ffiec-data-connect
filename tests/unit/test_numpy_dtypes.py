...
from ffiec_data_connect import xbrl_processor, methods
...
class TestNumpyDtypeFlow:
    ...
    def test_xbrl_processor_returns_numpy_types(self):
        ...
        with patch('ffiec_data_connect.xbrl_processor._process_xbrl_item') as mock_process:
            ...
            mock_xbrl_data = b'<?xml version="1.0"?><xbrl><cc:RCON2170>test</cc:RCON2170></xbrl>'
    ...
    def test_polars_conversion_maintains_types(self):
        ...
        df_pandas['int_data'] = df_pandas['int_data'].astype('Int64')  # Nullable integer
        df_pandas['float_data'] = df_pandas['float_data'].astype('float64')
        df_pandas['bool_data'] = df_pandas['bool_data'].astype('boolean')  # Nullable boolean
