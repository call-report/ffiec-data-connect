...
class TestSOAPClientCache:
    ...
    def test_cache_key_different_for_different_credentials(self):
        ...
        with patch.dict(
            "os.environ", {"FFIEC_USERNAME": "user1", "FFIEC_PASSWORD": "pass1"}
        ):
        ...
        with patch.dict(
            "os.environ", {"FFIEC_USERNAME": "user2", "FFIEC_PASSWORD": "pass2"}
        ):
    ...
    def test_cache_lru_eviction(self):
        ...
        with patch(
            "ffiec_data_connect.soap_cache.Client",
            ...
            with patch.dict(
                "os.environ", {"FFIEC_USERNAME": "user3", "FFIEC_PASSWORD": "pass3"}
            ):
