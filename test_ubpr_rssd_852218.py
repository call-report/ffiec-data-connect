#!/usr/bin/env python3
"""Test UBPR data collection for RSSD 852218."""
...
def test_ubpr_rssd_852218():
    ...
    print("TEST: UBPR Data Collection for RSSD 852218")
    print("=" * 55)
    ...
    try:
        ...
        # Test with a few different periods
        test_periods = []
        ...
        if "2023-12-31" in ubpr_periods:
            test_periods.append("2023-12-31")  # Specific period
